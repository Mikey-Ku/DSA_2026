...
def hold_alternative_vote(candidates, ranked_votes):
    ...
    candidates = [
        candidate for candidate in candidates if candidate != minimum_candidate
    ]
    return hold_alternative_vote(candidates, ranked_votes)


# Original, iterative implementation. DON'T CHANGE.
